#!/usr/bin/env python3
"""
JioMart Daily Shipment Report Downloader - v4
Runs daily via GitHub Actions at 10:00 AM IST
Uses xvfb-run + headless=False to bypass bot detection
"""
...
async def run():
    ...
    async with async_playwright() as p:
        # headless=False + xvfb-run avoids bot detection
        ...
        # Step 1: Login
        print("Navigating to JioMart login...")
        ...
        # Step 2: Left panel: Reports -> Shipment Report
        print("Opening Reports > Shipment Report...")
        ...
        for attempt in range(20):
            ...
            await screenshot(page, f"10_poll_{attempt+1:02d}")
